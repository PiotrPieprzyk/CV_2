	...
	<project-holder>
		<content-holder>
			...
			<template v-slot:right>
				<img src="@/assets/projects/dev/gemini/big-apteka-gemini.png" alt="" />
			</template>
		</content-holder>
		<content-holder>
			<template v-slot:left>
				...
				<p>
					...
					day. I went through courses such as: "JavaScript - The Complete Guide
		...
		<content-holder>
			<template v-slot:left>
				...
				<p>
					...
					interesting experience. While working on this project, I learned that
					by making connections, you can gather a lot more knowledge. The main
